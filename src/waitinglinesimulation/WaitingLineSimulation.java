...
public class WaitingLineSimulation {
    ...
    System.out.println("The average time a customer spends waiting in the queue   Minutes : %f\n\n"+ ""+Wq*60);
   ...
   System.out.println("How many probabilities that you want to test ? :\n") ;
    ...
    compare.Customers_greaterthan_N(num,arrivalNumbers,servedNumber,customers);
